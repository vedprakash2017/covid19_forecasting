def ifd(b):
    # -*- coding: utf-8 -*-
    """InferenceForecastDataJsonCode.ipynb

    Automatically generated by Colaboratory.

    Original file is located at
        https://colab.research.google.com/drive/1KCP4GBYxWxr3RzZWE-p2ThIo-tTWEA8I
    """
    ...
    edges = [
            (states[2],states[32]),(states[2],states[17]),(states[2],states[31]),(states[2],states[26]),(states[2],states[7]),
            (states[3],states[4]),(states[3],states[25]),
            (states[4],states[22]),(states[4],states[23]),(states[4],states[24]),(states[4],states[25]),(states[4],states[33]),(states[4],states[36]),
            (states[5],states[16]),(states[5],states[34]),(states[5],states[36]),
            (states[6],states[28]),(states[6],states[13]),
            (states[7],states[16]),(states[7],states[20]),(states[7],states[26]),(states[7],states[34]),(states[7],states[21]),(states[7],states[32]),
            (states[9],states[21]),(states[9],states[12]),
            (states[10],states[13]),(states[10],states[34]),
            (states[11],states[21]),(states[11],states[17]),
            (states[12],states[29]),(states[12],states[21]),(states[12],states[20]),
            (states[13],states[28]),(states[13],states[34]),(states[13],states[35]),(states[13],states[29]),(states[13],states[14]),
            (states[14],states[15]),(states[14],states[19]),(states[14],states[28]),(states[14],states[35]),(states[14],states[34]),
            (states[15],states[19]),(states[15],states[28]),
            (states[16],states[34]),(states[16],states[36]),(states[16],states[26]),
            (states[17],states[21]), (states[17],states[18]), (states[17],states[32]),(states[17],states[31]),
            (states[18],states[31]),
            (states[20],states[29]),(states[20],states[21]),(states[20],states[34]),
            (states[21],states[32]),
            (states[22],states[24]),(states[22],states[25]),
            (states[24],states[33]),
            (states[26],states[36]),
            (states[27],states[31]),
            (states[28],states[29]),
    ...
    test_state = ['Andaman and Nicobar Islands','Meghalaya','Mizoram','Sikkim','Nagaland']
    for s in test_state:
        state_subset = data[data['state'] == s]
        y = state_subset['totaltested'].fillna(method='ffill').fillna(0).values
        x = np.array([p for p in range(1,len(y)+1)])
        yparam = scipy.optimize.curve_fit(lambda t,a,b: a*np.exp(b*t),  x,  y,  p0=(4, 0.1))[0]
        yfit = yparam[0]*np.exp(yparam[1]*x)
        data.loc[state_subset.index,'totaltested'] = [round(j) for j in yfit]
    ...
    for date in ForecastData['date'].unique():
        ForecastSubset = ForecastData[(ForecastData['state']=='Total') & (ForecastData['date']==date)]
        NotTotalSubset = ForecastData[(ForecastData['state']!='Total') & (ForecastData['date']==date)]
        ForecastData.loc[ForecastSubset.index,'cum_confirmed'] = NotTotalSubset['cum_confirmed'].sum()
        ForecastData.loc[ForecastSubset.index,'cum_active'] = NotTotalSubset['cum_active'].sum()
        ForecastData.loc[ForecastSubset.index,'cum_recovered'] = NotTotalSubset['cum_recovered'].sum()
