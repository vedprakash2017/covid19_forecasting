...
print(f1_data['Andaman and Nicobar Islands'])
@app.route('/')
def line():
    return render_template('graph.html', title='Covid19',table1 = data,table2 = fdata,total = total,st = st,gdata = g_data,g1data = g1_data,fdata = f_data,f1data = f1_data,tav = tav)
